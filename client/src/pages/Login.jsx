...
const Login = () => {
  ...
  const onSubmitHandler = async(e)=>{
    try {
      ...
      //It will send the cookies also wuth the request
  ...
  return (
    <div className="flex items-center justify-center min-h-screen px-6 sm:px-0 bg-gradient-to-br from-blue-200 to-purple-400 ">
      ...
      <form onSubmit={onSubmitHandler}>
        ...
        <button className="w-full py-2.5 rounded-full bg-gradient-to-r from-indigo-500 to-indigo-900 texty-white font-medium">{state}</button>
      </form>
